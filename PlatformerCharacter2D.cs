...
namespace UnityStandardAssets._2D
{
    public class PlatformerCharacter2D : MonoBehaviour
    {
        ...
        [Range(0, 1)] [SerializeField] private float m_CrouchSpeed = 0.8f;  // Amount of maxSpeed applied to crouching movement. 1 = 100%
       ...
       // public float time;
        ...
        public void Move(float move, bool crouch, bool jump)
        {
            ...
            if (m_Grounded || m_AirControl)
            {
                ...
                // Move the character
                m_Rigidbody2D.velocity = new Vector2((m_MaxSpeed + move) , m_Rigidbody2D.velocity.y);
